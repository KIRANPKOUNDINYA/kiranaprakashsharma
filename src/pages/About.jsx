    ...
    <div id="about" className="py-20 bg-white text-gray-900 scroll-mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center px-4 sm:px-0">
            ...
            <div className="mt-6 max-w-3xl mx-auto space-y-4 text-lg text-gray-700 font-medium">
              <p>
                ...
                <strong className="text-orange-600">{t.about.intro1Name}</strong>
        ...
        <div className="bg-orange-600 rounded-2xl shadow-lg text-white py-10 px-6 sm:px-12 mb-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-orange-400">
            <div className="py-2">
              ...
              <span className="mt-2 block text-lg font-medium text-orange-100">{t.about.stats.blessedFamilies}</span>
            </div>
            <div className="py-2">
              <span className="block text-4xl font-extrabold">
                <AnimatedCounter end={22} duration={4000} />
              </span>
              <span className="mt-2 block text-lg font-medium text-orange-100">{t.about.stats.yearsWisdom}</span>
            </div>
            <div className="py-2">
              <span className="block text-4xl font-extrabold">
                <AnimatedCounter end={2000} duration={4000} />
              </span>
              <span className="mt-2 block text-lg font-medium text-orange-100">{t.about.stats.sacredCeremonies}</span>
            </div>
          </div>
        </div>
        ...
        <div className="mb-20 bg-orange-50 rounded-2xl p-8 lg:p-12 border-l-4 border-orange-600 shadow-sm">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">{t.about.journeyTitle}</h3>
          <p className="text-gray-700 mb-6 text-lg">{t.about.journeyText}</p>
          <ul className="space-y-4 text-gray-700 text-lg list-disc list-inside marker:text-orange-600 font-medium">
            {t.about.journeyBullets.map((bullet, index) => (
        ...
        <div className="text-center mb-12">
          <h3 className="text-3xl font-extrabold text-gray-900">{t.about.whyTitle}</h3>
          <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">{t.about.whyText}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white p-6 rounded-xl border border-orange-100 shadow-sm hover:shadow-md transition">
            ...
            <h4 className="text-xl font-bold text-gray-900 mb-2">{t.about.features[0].title}</h4>
            <p className="text-gray-600">{t.about.features[0].description}</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-orange-100 shadow-sm hover:shadow-md transition">
            ...
            <h4 className="text-xl font-bold text-gray-900 mb-2">{t.about.features[1].title}</h4>
            <p className="text-gray-600">{t.about.features[1].description}</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-orange-100 shadow-sm hover:shadow-md transition">
            ...
            <h4 className="text-xl font-bold text-gray-900 mb-2">{t.about.features[2].title}</h4>
            <p className="text-gray-600">{t.about.features[2].description}</p>
          </div>
